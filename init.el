...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(minions doom-themes doom-modeline powershell markdown-mode+ yaml-mode magit rjsx-mode esup 0blayout twittering-mode solarized-theme undo-tree company-restclient restclient-helm web-mode uuidgen tide smex restclient rainbow-delimiters neotree mocha less-css-mode js2-refactor ido-ubiquitous helm-projectile haskell-mode git-rebase-mode git-commit-mode flycheck-color-mode-line company color-theme-sanityinc-tomorrow clj-refactor avy auto-complete ac-js2))))
